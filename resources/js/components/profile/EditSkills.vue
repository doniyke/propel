...
<template>
    <div class="row gx-1 mb-3" v-for="(tool, index) in addedSkills" :key="index">
        <div class="col-8">
            <input type="text" class="form-control" disabled :value="tool.tool">
        </div>
        <div class="col-4">
