...
<template>
    <div class="personal-info">
        <div class="d-flex justify-content-between">
            ...
            <div>
                <button ref="modalBtn" class="btn-edit"  data-bs-toggle="modal" data-bs-target="#exampleModal2">
                    <span>
    ...
    <div class="work-info">
        <EducationData @edit-button-clicked="handleEditButtonClicked" />
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel2"> {{ modalType == 'add' ? 'Add Education' : 'Edit Education' }}</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div>
                            ...
                            <input type="text" class="form-control" placeholder="E.g; Senior DevOps Engineer" v-model="userWorkExperience.school">
                        </div>
                        <div>
                            <label class="form-label">Degree</label>
                            <input type="text" class="form-control" placeholder="E.g; Paystack" v-model="userWorkExperience.degree">
                        </div>
                        <div>
                            <label class="form-label">Field of study</label>
                            <input type="text" class="form-control" placeholder="https://" v-model="userWorkExperience.field">
                        </div>
                        <div>
